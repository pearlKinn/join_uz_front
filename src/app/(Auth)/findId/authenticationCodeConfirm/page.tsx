  ...
  return (
    <section className="min-w-[360px] h-lvh flex flex-col px-4">
      ...
      <main className="flex flex-col items-center">
        ...
        <button
          type="submit"
          className={`disabled:bg-gray200 bg-gray600 disabled:text-textInactive text-gray100 rounded w-[328px] h-10 px-3 textSM ${authenticationCode ? "hover:bg-gray500" : ""}`}
